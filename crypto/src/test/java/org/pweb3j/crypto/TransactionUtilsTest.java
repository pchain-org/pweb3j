...
import static org.pweb3j.crypto.TransactionUtils.generateTransactionHashHexEncoded;
...
public class TransactionUtilsTest {
    ...
    */
    ...
    public void testGenerateEip155TransactionHash() {
        assertThat(generateTransactionHashHexEncoded(
                TransactionEncoderTest.createContractTransaction(), BigInteger.valueOf(1),
