package org.pweb3j.protocol.rx;
...
import org.pweb3j.protocol.core.DefaultBlockParameterNumber;
import org.pweb3j.protocol.core.filters.BlockFilter;
import org.pweb3j.protocol.core.filters.LogFilter;
import org.pweb3j.protocol.core.filters.PendingTransactionFilter;
import org.pweb3j.protocol.core.methods.response.EthBlock;
import org.pweb3j.protocol.core.methods.response.Log;
import org.pweb3j.protocol.core.methods.response.Transaction;
import org.pweb3j.utils.Flowables;
...
public class JsonRpc2_0Rx {
    ...
    public Flowable<Log> ethLogFlowable(
            org.pweb3j.protocol.core.methods.request.EthFilter ethFilter, long pollingInterval) {
        return Flowable.create(subscriber -> {
    ...
    private <T> void run(
            org.pweb3j.protocol.core.filters.Filter<T> filter, FlowableEmitter<? super T> emitter,
