...
import org.pweb3j.abi.datatypes.generated.AbiTypes;
import org.pweb3j.crypto.Credentials;
import org.pweb3j.protocol.ObjectMapperFactory;
...
import org.pweb3j.utils.Collection;
import org.pweb3j.utils.Strings;
import org.pweb3j.utils.Version;
...
public class SolidityFunctionWrapper extends Generator {
    ...
    private void addAddressesSupport(TypeSpec.Builder classBuilder,
        ...
        if (addresses != null) {
            ...
            // See org.pweb3j.tx.Contract#getStaticDeployedAddress(String)
    ...
    TypeSpec buildEventResponseObject(
            String className,
            List<org.pweb3j.codegen.SolidityFunctionWrapper.NamedTypeName> indexedParameters,
            List<org.pweb3j.codegen.SolidityFunctionWrapper.NamedTypeName> nonIndexedParameters) {

        TypeSpec.Builder builder = TypeSpec.classBuilder(className)
                .addModifiers(Modifier.PUBLIC, Modifier.STATIC);

        builder.addField(LOG, "log", Modifier.PUBLIC);
        for (org.pweb3j.codegen.SolidityFunctionWrapper.NamedTypeName
    ...
    private static Class<?> getStaticArrayTypeReferenceClass(String type) {
        try {
            return Class.forName("org.pweb3j.abi.datatypes.generated.StaticArray" + type);
