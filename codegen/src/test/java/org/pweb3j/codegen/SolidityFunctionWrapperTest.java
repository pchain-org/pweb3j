...
import org.pweb3j.abi.datatypes.Address;
...
import org.pweb3j.abi.datatypes.generated.Int256;
import org.pweb3j.abi.datatypes.generated.StaticArray10;
import org.pweb3j.abi.datatypes.generated.StaticArray2;
import org.pweb3j.abi.datatypes.generated.StaticArray3;
import org.pweb3j.abi.datatypes.generated.Uint256;
import org.pweb3j.abi.datatypes.generated.Uint64;
import org.pweb3j.protocol.core.methods.response.AbiDefinition;
...
import static org.pweb3j.codegen.SolidityFunctionWrapper.buildTypeName;
import static org.pweb3j.codegen.SolidityFunctionWrapper.createValidParamName;
import static org.pweb3j.codegen.SolidityFunctionWrapper.getEventNativeType;
import static org.pweb3j.codegen.SolidityFunctionWrapper.getNativeType;
...
public class SolidityFunctionWrapperTest extends TempFileProvider {
    ...
    public void testBuildFunctionTransaction() throws Exception {
        ...
        //CHECKSTYLE:OFF
        String expected =
                "public org.pweb3j.protocol.core.RemoteCall<org.pweb3j.protocol.core.methods.response.TransactionReceipt> functionName(java.math.BigInteger param) {\n"
                        + "  final org.pweb3j.abi.datatypes.Function function = new org.pweb3j.abi.datatypes.Function(\n"
                        + "      FUNC_FUNCTIONNAME, \n"
                        + "      java.util.Arrays.<org.pweb3j.abi.datatypes.Type>asList(new org.pweb3j.abi.datatypes.generated.Uint8(param)), \n"
                        + "      java.util.Collections.<org.pweb3j.abi.TypeReference<?>>emptyList());\n"
    ...
    public void testBuildPayableFunctionTransaction() throws Exception {
        ...
        //CHECKSTYLE:OFF
        String expected =
                "public org.pweb3j.protocol.core.RemoteCall<org.pweb3j.protocol.core.methods.response.TransactionReceipt> functionName(java.math.BigInteger param, java.math.BigInteger weiValue) {\n"
                        + "  final org.pweb3j.abi.datatypes.Function function = new org.pweb3j.abi.datatypes.Function(\n"
                        + "      FUNC_FUNCTIONNAME, \n"
                        + "      java.util.Arrays.<org.pweb3j.abi.datatypes.Type>asList(new org.pweb3j.abi.datatypes.generated.Uint8(param)), \n"
                        + "      java.util.Collections.<org.pweb3j.abi.TypeReference<?>>emptyList());\n"
    ...
    public void testBuildFunctionConstantSingleValueReturn() throws Exception {
        ...
        //CHECKSTYLE:OFF
        String expected =
                "public org.pweb3j.protocol.core.RemoteCall<java.math.BigInteger> functionName(java.math.BigInteger param) {\n"
                        + "  final org.pweb3j.abi.datatypes.Function function = new org.pweb3j.abi.datatypes.Function(FUNC_FUNCTIONNAME, \n"
                        + "      java.util.Arrays.<org.pweb3j.abi.datatypes.Type>asList(new org.pweb3j.abi.datatypes.generated.Uint8(param)), \n"
                        + "      java.util.Arrays.<org.pweb3j.abi.TypeReference<?>>asList(new org.pweb3j.abi.TypeReference<org.pweb3j.abi.datatypes.generated.Int8>() {}));\n"
    ...
    public void testBuildFunctionConstantSingleValueRawListReturn() throws Exception {
        ...
        //CHECKSTYLE:OFF
        String expected =
                "public org.pweb3j.protocol.core.RemoteCall<java.util.List> functionName(java.math.BigInteger param) {\n"
                + "  final org.pweb3j.abi.datatypes.Function function = new org.pweb3j.abi.datatypes.Function(FUNC_FUNCTIONNAME, \n"
                + "      java.util.Arrays.<org.pweb3j.abi.datatypes.Type>asList(new org.pweb3j.abi.datatypes.generated.Uint8(param)), \n"
                + "      java.util.Arrays.<org.pweb3j.abi.TypeReference<?>>asList(new org.pweb3j.abi.TypeReference<org.pweb3j.abi.datatypes.DynamicArray<org.pweb3j.abi.datatypes.Address>>() {}));\n"
                + "  return new org.pweb3j.protocol.core.RemoteCall<java.util.List>(\n"
                + "      new java.util.concurrent.Callable<java.util.List>() {\n"
                + "        @java.lang.Override\n"
                + "        @java.lang.SuppressWarnings(\"unchecked\")\n"
                + "        public java.util.List call() throws java.lang.Exception {\n"
                + "          java.util.List<org.pweb3j.abi.datatypes.Type> result = (java.util.List<org.pweb3j.abi.datatypes.Type>) executeCallSingleValueReturn(function, java.util.List.class);\n"
    ...
    public void testBuildFunctionConstantMultipleValueReturn() throws Exception {
        ...
        //CHECKSTYLE:OFF
        String expected = "public org.pweb3j.protocol.core.RemoteCall<org.pweb3j.tuples.generated.Tuple2<java.math.BigInteger, java.math.BigInteger>> functionName(java.math.BigInteger param1, java.math.BigInteger param2) {\n"
                + "  final org.pweb3j.abi.datatypes.Function function = new org.pweb3j.abi.datatypes.Function(FUNC_FUNCTIONNAME, \n"
                + "      java.util.Arrays.<org.pweb3j.abi.datatypes.Type>asList(new org.pweb3j.abi.datatypes.generated.Uint8(param1), \n"
                + "      new org.pweb3j.abi.datatypes.generated.Uint32(param2)), \n"
                + "      java.util.Arrays.<org.pweb3j.abi.TypeReference<?>>asList(new org.pweb3j.abi.TypeReference<org.pweb3j.abi.datatypes.generated.Int8>() {}, new org.pweb3j.abi.TypeReference<org.pweb3j.abi.datatypes.generated.Int32>() {}));\n"
                + "  return new org.pweb3j.protocol.core.RemoteCall<org.pweb3j.tuples.generated.Tuple2<java.math.BigInteger, java.math.BigInteger>>(\n"
                + "      new java.util.concurrent.Callable<org.pweb3j.tuples.generated.Tuple2<java.math.BigInteger, java.math.BigInteger>>() {\n"
                + "        @java.lang.Override\n"
                + "        public org.pweb3j.tuples.generated.Tuple2<java.math.BigInteger, java.math.BigInteger> call() throws java.lang.Exception {\n"
                + "          java.util.List<org.pweb3j.abi.datatypes.Type> results = executeCallMultipleValueReturn(function);\n"
                + "          return new org.pweb3j.tuples.generated.Tuple2<java.math.BigInteger, java.math.BigInteger>(\n"
    ...
    public void testBuildEventConstantMultipleValueReturn() throws Exception {
        ...
        String expected =
                "class testClass {\n"
                        + "  public static final org.pweb3j.abi.datatypes.Event TRANSFER_EVENT = new org.pweb3j.abi.datatypes.Event(\"Transfer\", \n"
                        + "      java.util.Arrays.<org.pweb3j.abi.TypeReference<?>>asList(new org.pweb3j.abi.TypeReference<org.pweb3j.abi.datatypes.Utf8String>(true) {}, new org.pweb3j.abi.TypeReference<org.pweb3j.abi.datatypes.Address>(true) {}, new org.pweb3j.abi.TypeReference<org.pweb3j.abi.datatypes.Address>(true) {}, new org.pweb3j.abi.TypeReference<org.pweb3j.abi.datatypes.generated.Uint256>() {}, new org.pweb3j.abi.TypeReference<org.pweb3j.abi.datatypes.Utf8String>() {}));\n  ;\n\n"
                        + "  public java.util.List<TransferEventResponse> getTransferEvents(org.pweb3j.protocol.core.methods.response.TransactionReceipt transactionReceipt) {\n"
                        + "    java.util.List<org.pweb3j.tx.Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(TRANSFER_EVENT, transactionReceipt);\n"
                        + "    java.util.ArrayList<TransferEventResponse> responses = new java.util.ArrayList<TransferEventResponse>(valueList.size());\n"
                        + "    for (org.pweb3j.tx.Contract.EventValuesWithLog eventValues : valueList) {\n"
                        ...
                        + "  }\n"
                        + "\n"
                        + "  public io.reactivex.Flowable<TransferEventResponse> transferEventFlowable(org.pweb3j.protocol.core.methods.request.EthFilter filter) {\n"
                        + "    return web3j.ethLogFlowable(filter).map(new io.reactivex.functions.Function<org.pweb3j.protocol.core.methods.response.Log, TransferEventResponse>() {\n"
                        + "      @java.lang.Override\n"
                        + "      public TransferEventResponse apply(org.pweb3j.protocol.core.methods.response.Log log) {\n"
                        + "        org.pweb3j.tx.Contract.EventValuesWithLog eventValues = extractEventParametersWithLog(TRANSFER_EVENT, log);\n"
                        + "        TransferEventResponse typedResponse = new TransferEventResponse();\n"
                        ...
                        + "  }\n"
                        + "\n"
                        + "  public io.reactivex.Flowable<TransferEventResponse> transferEventFlowable(org.pweb3j.protocol.core.DefaultBlockParameter startBlock, org.pweb3j.protocol.core.DefaultBlockParameter endBlock) {\n"
                        + "    org.pweb3j.protocol.core.methods.request.EthFilter filter = new org.pweb3j.protocol.core.methods.request.EthFilter(startBlock, endBlock, getContractAddress());\n"
                        + "    filter.addSingleTopic(org.pweb3j.abi.EventEncoder.encode(TRANSFER_EVENT));\n"
                        + "    return transferEventFlowable(filter);\n"
                        + "  }\n"
                        + "\n"
                        + "  public static class TransferEventResponse {\n"
                        + "    public org.pweb3j.protocol.core.methods.response.Log log;\n"
                        + "\n"
                        + "    public byte[] id;\n"
                        + "\n"
