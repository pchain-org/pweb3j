...
public class Arrays extends Contract {
    ...
    public RemoteCall<List> multiDynamic(List<List<BigInteger>> input) {
        final Function function = new Function(FUNC_MULTIDYNAMIC, 
                java.util.Arrays.<Type>asList(new org.pweb3j.abi.datatypes.DynamicArray(
                        org.pweb3j.abi.Utils.typeMap(input, org.pweb3j.abi.datatypes.generated.StaticArray2.class, org.pweb3j.abi.datatypes.generated.Uint256.class))), 
    ...
    public RemoteCall<List> multiFixed(List<List<BigInteger>> input) {
        final Function function = new Function(FUNC_MULTIFIXED, 
                java.util.Arrays.<Type>asList(new org.pweb3j.abi.datatypes.generated.StaticArray6(
                        org.pweb3j.abi.Utils.typeMap(input, org.pweb3j.abi.datatypes.generated.StaticArray2.class, org.pweb3j.abi.datatypes.generated.Uint256.class))), 
                java.util.Arrays.<TypeReference<?>>asList(new TypeReference<DynamicArray<Uint256>>() {}));
        return new RemoteCall<List>(
                new Callable<List>() {
    ...
    public RemoteCall<List> fixedReverse(List<BigInteger> input) {
        final Function function = new Function(FUNC_FIXEDREVERSE, 
                java.util.Arrays.<Type>asList(new org.pweb3j.abi.datatypes.generated.StaticArray10<org.pweb3j.abi.datatypes.generated.Uint256>(
                        org.pweb3j.abi.Utils.typeMap(input, org.pweb3j.abi.datatypes.generated.Uint256.class))), 
    ...
    public RemoteCall<List> dynamicReverse(List<BigInteger> input) {
        final Function function = new Function(FUNC_DYNAMICREVERSE, 
                java.util.Arrays.<Type>asList(new org.pweb3j.abi.datatypes.DynamicArray<org.pweb3j.abi.datatypes.generated.Uint256>(
                        org.pweb3j.abi.Utils.typeMap(input, org.pweb3j.abi.datatypes.generated.Uint256.class))), 
                java.util.Arrays.<TypeReference<?>>asList(new TypeReference<DynamicArray<Uint256>>() {}));
        return new RemoteCall<List>(
                new Callable<List>() {
