...
import org.pweb3j.protocol.ResponseTester;
import org.pweb3j.protocol.core.methods.response.VoidResponse;
import org.pweb3j.protocol.parity.methods.response.FullTraceInfo;
...
import org.pweb3j.protocol.parity.methods.response.ParityFullTraceResponse;
import org.pweb3j.protocol.parity.methods.response.ParityListRecentDapps;
import org.pweb3j.protocol.parity.methods.response.StateDiff;
import org.pweb3j.protocol.parity.methods.response.Trace;
import org.pweb3j.protocol.parity.methods.response.VMTrace;
...
public class ResponseTest extends ResponseTester {
    ...
    public void testParityFullTraceResponseTraces() {
        ...
        //CHECKSTYLE:OFF
        org.pweb3j.protocol.parity.methods.response.Trace trace1 = new org.pweb3j.protocol.parity.methods.response.Trace();
        ...
        org.pweb3j.protocol.parity.methods.response.Trace trace2 = new org.pweb3j.protocol.parity.methods.response.Trace();
        ...
        org.pweb3j.protocol.parity.methods.response.Trace trace3 = new org.pweb3j.protocol.parity.methods.response.Trace();
        ...
        org.pweb3j.protocol.parity.methods.response.Trace trace4 = new org.pweb3j.protocol.parity.methods.response.Trace();
        ...
        List<org.pweb3j.protocol.parity.methods.response.Trace> traces = new ArrayList<>();
        traces.add(trace1);
        traces.add(trace2);
        traces.add(trace3);
        traces.add(trace4);
